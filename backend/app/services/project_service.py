...
async def import_project_by_key(db: AsyncSession, project_key: str, current_user: User):
    ...
    result = await import_project_stories(db, project, jira_issues=jira_issues)
